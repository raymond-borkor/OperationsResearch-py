...
import os
#Cost Matrix Here, based on data gathered.
costs  = {'W': {'A': 34, 'B': 84, 'C': 12, 'D': 75},
          'X': {'A': 45, 'B': 56, 'C': 90, 'D': 87},
          'Y': {'A': 68, 'B': 67, 'C': 68, 'D': 54}}
demand = {'A': 80, 'B': 65, 'C': 70, 'D': 85}
cols = sorted(demand.iterkeys())
supply = {'W': 75, 'X': 125, 'Y': 100}
res = dict((k, defaultdict(int)) for k in costs)
g = {}
#costs  = {'W': {'A': 30, 'B': 10, 'C': 25, 'D': 20},
 #         'X': {'A': 15, 'B': 25, 'C': 30, 'D': 10},
  #        'Y': {'A': 20, 'B': 30, 'C': 15, 'D': 20}}
#demand = {'A': 1000, 'B': 1200, 'C': 1500, 'D': 1000}
#cols = sorted(demand.iterkeys())
#supply = {'W': 1500, 'X': 1500, 'Y': 1700}
#res = dict((k, defaultdict(int)) for k in costs)
#g = {}
